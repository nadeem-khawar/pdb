...
double defaultScreenHeight = 2246.0;
...
class Constant {
  ...
  static void setScreenAwareConstant(context) {
    ...
    /*Screen Size dependent Constants*/
    screenWidthHalf = ScreenUtil.defaultWidth / 2;
    screenWidthThird = ScreenUtil.defaultWidth / 3;
    screenWidthFourth = ScreenUtil.defaultWidth / 4;
    screenWidthFifth = ScreenUtil.defaultWidth / 5;
    screenWidthSixth = ScreenUtil.defaultWidth / 6;
    screenWidthTenth = ScreenUtil.defaultWidth / 10;
